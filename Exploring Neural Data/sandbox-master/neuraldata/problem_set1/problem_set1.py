...
#    plot_spikes(t, v, APTimes, 'Spikes for easy datasets')
#    plot_waveforms(t, v, APTimes, 'Waveforms for easy datasets')
...
#    t1, v1 = load_data('spikes_hard_practice.npy')
    ...
    plot_spikes(t1, v1, APTimes1, 'Spikes for hard datasets')
    plot_waveforms(t1, v1, APTimes1, 'Waveforms for hard datasets')
