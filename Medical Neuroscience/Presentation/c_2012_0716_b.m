...
%     end
    traditonal_meet_num_result(do_i) = traditonal_meet_num;
    simplified_meet_num_result(do_i) = simplified_meet_num;
    traditonal_no_meet_num_result(do_i) = traditonal_no_meet_num;
    simplified_no_meet_num_result(do_i) = simplified_no_meet_num;
